...
<section id="nino-ourTeam">
	<div class="container">
		<h2 class="nino-sectionHeading title wow fadeInDown">
			<span class="nino-subHeading" style="font-family: '微軟正黑體';font-size: 40px;">愛心捐款</span>
		</h2>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content" id="nino-whatWeDo">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" style="font-family: '微軟正黑體'; font-size: 20px; font-weight: bold;">${捐款箱名稱}</h4>
				<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
					<button type="button" class="btn btn-danger btn-lg" id=delPayBox style="border: 0px #9ae2d5; margin-top: -10px; margin-right: 30px; margin-bottom: -10px; float: right;">
                             81000
					</button>
				</a>
			</div>
						...
						<div class="modal-body">
							...
							<div class="panel-heading" role="tab" id="headingOne">
								<h4 class="panel-title">
									<div style="font-family: '微軟正黑體'; font-size: 16px; font-weight: bold;">捐款箱詳述</div>
								</h4>
							</div>
					...
					<div class="col-md-6" style="margin: 30px 30px;">
						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingOne">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#payBoxOutList" aria-expanded="false"
										 aria-controls="payBoxOutList">
											<i class="mdi mdi-chevron-up nino-icon arrow"></i>
											<i class="fas fa-user-alt nino-icon"></i>
											<div style="text-align: left;">花費明細</div>
										</a>
									</h4>
								</div>
								<div id="payBoxOutList" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="payBoxOut_list panel-body" style="height: auto;">
										<div class="input-group input-group-lg" style="height: 15px;">
											<span class="input-group-btn">
												<div class="btn-warning btn" style="width: 300px; cursor: default; font-style: normal; font-size: 18px; background: #f9df6b; text-align: left;font-color: black;">花費名稱</div>
											</span>
											<div id="payBoxOut_value" type="text" name="memName" class="form-control" style="z-index: 1; text-align: right;">$花費</div>
										</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingTwo">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#payBoxInList" aria-expanded="false"
										 aria-controls="payBoxInList">
											<i class="mdi mdi-chevron-up nino-icon arrow"></i>
											<i class="fas fa-phone nino-icon"></i>
											<div style="text-align: left;">捐款明細</div>
										</a>
									</h4>
								</div>
								<div id="payBoxInList" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									<div class="panel-body" style="height: auto;">
										<div class="input-group input-group-lg payBoxIn_list" style="height: 15px;">
											<span class="input-group-btn">
												<div class="btn-warning btn" style="width: 300px; cursor: default; font-style: normal; font-size: 18px; text-align: left;">捐款人</div>
											</span>
											<div id="payBoxIn_value" type="text" name="memName" class="form-control" style="z-index: 1; text-align: right;">$金額</div>
										</div>
									</div>
								</div>
	...
	<div class="modal-dialog " role="document" style="z-index:1042;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel" style="font-family: '微軟正黑體';font-size: 20px;">捐款清單</h4>
			</div>
			<div class="modal-body">
				<div id="collapseOne1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body" style="height: auto;">
						...
						<div class="input-group input-group-lg">
							<span class="input-group-btn">
								<button class="btn btn-success" type="submit" style="width: 130px; cursor:default; ">本次捐款總額: </button>
							</span>
							<input disabled="disabled" type="text" id="show_Payment" class="form-control" placeholder="請點選右下方捐款金額按鈕" style="cursor:default; z-index: 1; text-align :right;">
						</div>
						<div style="margin-top:2%;">
							<div class="row" style=" float:right;">
								<div class="col-md-4" style="padding-left:5px;">
									<button id="plus100" value="100" type="button" class="btn btn-primary" style="width:70px; font-family: '微軟正黑體';font-size: 15px;">$100</button>
								</div>
								<div class="col-md-4" style="padding-left:5px;">
									<button id="plus500" value=500 "" type="button" class="btn btn-primary" style="width:70px; font-family: '微軟正黑體';font-size: 15px;">$500</button>
								</div>
								<div class="col-md-4" style="padding-left:5px;">
									<button id="plus1000" value="1000" type="button" class="btn btn-primary" style="width:70px; font-family: '微軟正黑體';font-size: 15px;">$1000</button>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" id="send2Final" class="btn btn-primary" data-toggle="modal" data-target="#myModal4" style="font-family: '微軟正黑體';font-size: 15px;">確認送出</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal " id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-sm" role="document" style="z-index:1043;">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
