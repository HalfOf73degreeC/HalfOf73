...
<header id="nino-story">
		...
		<div class="container">
			<h2 class="nino-sectionHeading title wow fadeInDown">
				<span class="nino-subHeading"
					style="font-family: '微軟正黑體'; font-size: 40px;">愛心商品管理</span>
			</h2>
	...
	jQuery.fn.showGoods_D = function(Goods) {
		$('body').reNewGoodModal();
		var goodsName = $('#goodsName').val(Goods.goodsName);
		var goodsStock = $('#goodsStock').val(Goods.goodsStock);
...
// 					console.log(crop_img);
	...
	jQuery.fn.clickGoods = function() {
		$(".Goods").on("click", function() {
			var goodsUid = $(this).attr("date-goodsUid")
			console.log("檢視Goods");
			for (var i = 0; i < GoodsList.length; i++) {
				var Goods = GoodsList[i];
				if (Goods.goodsUid == goodsUid) {
					Goods_now = Goods
					$('body').showGoods_D(Goods);
