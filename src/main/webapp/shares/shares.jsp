...
// 												console.log(oneNews);
								        ...
								        for (var i = 0; i < newslist.length; i++) {
											var shares = newslist[i];
											if (shares.sharesUid == sharesId) {
												$( "#oneNews" ).append('<h1 style="font-weight: bold;">'+shares.sharesName+'</h1>');
											    $( "#oneNews" ).append('<p>'+shares.insertDate+'</p>');
											    $( "#oneNews" ).append('<h4>'+shares.sharesArticle+'</h4>');
											    $( "#oneNews" ).append('<img width="100%" src="'+shares.sharesImg+'"/>');
											}
								        }
