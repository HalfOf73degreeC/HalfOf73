					...
					<div class="col-md-4 col-sm-4">
						<article>
							<div class="articleThumb">
								...
								<div class="date">
									<span class="number">庫存</span> <span class="text">${GoodsBean.goodsStock}</span>
								</div>
							</div>
							...
							<div style="padding: 10px;">
								...
								<p class="articleDesc">${GoodsBean.goodsIntro}</p>
							</div>
							<h3 class="articleTitle" style="text-align: right;">
								<a href="#" style="color: red; font-weight: bold;">愛心價：${GoodsBean.goodsPrice}
									元</a>
							</h3>
							<div class="articleMeta">
								<a href="#"><i class="mdi mdi-eye nino-icon"></i>
									${GoodsBean.goodsView}</a>
